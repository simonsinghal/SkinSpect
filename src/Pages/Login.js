...
=======
        ...
        <div className="login-right w-1/2 flex flex-col justify-center px-20 overflow-y-auto">
          ...
          {error && <p className="text-red-500 mb-4">{error}</p>} {/* Show API error */}
...
=======
            ...
            <div className="mt-6 flex flex-col items-center w-2/3">
              <Link to="/forgot-password" className="forgot-password text-base underline text-[#02298A] hover:text-[#0056b3] transition duration-300 mb-4 text-center">
                Forgot Password?
              </Link>
