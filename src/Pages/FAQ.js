...
export default function FAQ() {
    const faqs = [
        ...
        {
            question: "Is Skinspect free to use?",
            answer: "Yes, Skinspect is free to use with optional premium features for advanced insights.",
        },
        {
            question: "Can Skinspect detect all skin conditions?",
            answer:
        ...
        <div className="font-montserrat min-h-screen flex flex-col">
            ...
            <main className="flex-grow flex flex-col items-center justify-center relative">
                <div className="faq-heading-container relative w-full max-w-2xl mb-8">
                    ...
                    <div className="faq-heading-background absolute inset-0 rounded-xl bg-cover bg-center opacity-50" style={{ backgroundImage: `url(${BackgroundImage})` }}></div>
                </div>
                        ...
                        {faqs.map((faq, index) => (
                            <AccordionItem key={index} value={faq.question}>
                                ...
                                >
                                    ...
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className={`h-6 w-6 transition-transform duration-300 ${openItems.includes(faq.question) ? 'rotate-180' : ''}`}
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke="currentColor"
                                    >
                                ...
                                <div className={`p-4 bg-gray-100 rounded-b-lg ${openItems.includes(faq.question) ? 'block' : 'hidden'}`}>
                                    {faq.answer}
                                </div>
                            </AccordionItem>
                        ))}
